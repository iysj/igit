...
<html>
  <head>
	...
	<script type="text/javascript" src="${ctx }/resources/js/layout/main.js"></script>
  </head>
  ...
  <body class="easyui-layout">
    ...
    <div class="ui-header" data-options="region:'north',split:true,border:false" style="height:40px;overflow: hidden;">
 	...
 	<div  class="ui-login">
 		<div class="ui-login-info">
 			...
 			<a class="logout-btn" href="${ctx}/logout.do">退出</a>
 		</div>
 	</div>
 	</div>
	<!-- menu -->
	<div data-options="region:'west',split:true,title:'系统菜单'" style="width:200px;">
		<div id="tree-box" class="easyui-accordion" data-options="fit:true,border:false">
			...
			<div title="${item.text}">
				...
				<a class="menu-item" href="${ctx}${node.url}">${node.text}</a>
				</c:forEach>
			</div>
			</c:forEach>
		</div>
	...
	<div data-options="region:'south',split:true,border:false" style="height: 30px;overflow:hidden;">
		<div class="panel-header" style="border: none;text-align: center;" >CopyRight &copy; 2015 King 版权所有. &nbsp;&nbsp; kingsj.yuan@foxmail.com</div>
	</div>
	<!-- center -->
